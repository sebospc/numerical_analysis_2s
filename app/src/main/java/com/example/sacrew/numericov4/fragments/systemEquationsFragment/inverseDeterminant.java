...
public class inverseDeterminant extends baseFactorizationMethods {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private void generalFactorization(double[][] expandedMatrix) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private void progresiveSubstitution(Complex[][] matrixLComplex) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private Complex[] substitution(Complex[][] expandedMatrix) {
