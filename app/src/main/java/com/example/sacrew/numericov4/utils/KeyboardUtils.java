...
public class KeyboardUtils {
    ...
    private final Keyboard key123, keyFunctions;
    ...
    public KeyboardUtils(View view, int keyboardViewId, Context context) {
        ...
        KeyboardView.OnKeyboardActionListener keyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
            ...
            public void onKey(int primaryCode, int[] keyCodes) {
                ...
                switch (primaryCode) {
                    case xLetter:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "x");
                        break;
                    case pi:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "pi");
                        break;
                    case euler:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "e");
                        break;
                    case 9:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "9");
                        break;
                    case 8:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "8");
                        break;
                    case 7:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "7");
                        break;
                    case multipier:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "*");
                        break;
                    case div:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "/");
                        break;
                    case xSquareTwo:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "^(2)");
                        break;
                    case xSquareAny:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "^()");
                        actualEditText.setSelection(actualEditText.getSelectionStart() - 1);
                        break;
                    case xSquareRoot:
                        checkLeftParent(actualEditText, "sqrt");
                        break;
                    case 6:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "6");
                        break;
                    case 5:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "5");
                        break;
                    case 4:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "4");
                        break;
                    case plus:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "+");
                        break;
                    ...
                    case rightParent:
                        ...
                        break;
                    case 3:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "3");
                        break;
                    case 2:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "2");
                        break;
                    case 1:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "1");
                        break;
                    case left:
                        moveCursorLeft(actualEditText);
                        break;
                    case right:
                        moveCursorRight(actualEditText);
                        break;
                    case cos:
                        checkLeftParent(actualEditText, "cos");
                        break;
                    case sin:
                        checkLeftParent(actualEditText, "sin");
                        break;
                    case tan:
                        checkLeftParent(actualEditText, "tan");
                        break;
                    case absolute:
                        checkLeftParent(actualEditText, "abs");
                        break;
                    case 0:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "0");
                        break;
                    case dot:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), ".");
                        break;
                    case cot:
                        checkLeftParent(actualEditText, "cot");
                        break;
                    case sec:
                        checkLeftParent(actualEditText, "sec");
                        break;
                    case csc:
                        checkLeftParent(actualEditText, "csc");
                        break;
                    case ln:
                        checkLeftParent(actualEditText, "ln");
                        break;
                    case cosInverse:
                        checkLeftParent(actualEditText, "acos");
                        break;
                    case sinInverse:
                        checkLeftParent(actualEditText, "asin");
                        break;
                    case tanInverse:
                        checkLeftParent(actualEditText, "atan");
                        break;
                    case cotInverse:
                        checkLeftParent(actualEditText, "acot");
                        break;
                    case secInverse:
                        checkLeftParent(actualEditText, "asec");
                        break;
                    case cosh:
                        checkLeftParent(actualEditText, "cosh");
                        break;
                    case sinh:
                        checkLeftParent(actualEditText, "sinh");
                        break;
                    case coth:
                        checkLeftParent(actualEditText, "coth");
                        break;
                    case tanh:
                        checkLeftParent(actualEditText, "tanh");
                        break;
                    case sech:
                        checkLeftParent(actualEditText, "sech");
                        break;
                    case csch:
                        checkLeftParent(actualEditText, "csch");
                        break;
                    case logTenBase:
                        checkLeftParent(actualEditText, "log10");
                        break;
                    case logAnyBase:
                        checkLeftParent(actualEditText, "log");
                        actualEditText.setSelection(actualEditText.getSelectionStart() - 1);
                        break;
                    case tenPowerAny:
                        actualEditText.getText().insert(actualEditText.getSelectionStart(), "1E");
                        break;
                    default:
                        break;
                }
                    ...
                    public void onTabSelected(TabLayout.Tab tab) {
                        switch (tab.getPosition()) {
                            ...
                            case 1:
                                closeMyFunctionsSection();
                                showKeyBoard();
                                keyboardView.setKeyboard(keyFunctions);
                                break;
                            case 2:
                                showMyFunctionsSection();
                                break;
                            default:
                                break;
                        }
    ...
    private void deleteLast(EditText edit) {
        if (edit.getSelectionStart() > 0) {
            StringBuilder text = new StringBuilder(edit.getText().toString());
            int aux = edit.getSelectionStart() - 1;
