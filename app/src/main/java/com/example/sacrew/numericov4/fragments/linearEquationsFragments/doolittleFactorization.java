 ...
 */
public class doolittleFactorization extends Fragment {

    private View view;
    private TableLayout matrix;
    private LinearLayout equals;
    private Button run,add;
    public doolittleFactorization() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_doolittle, container, false);
    ...
    public void paintMatrix(int n){
        ...
        for(int i = 1; i<=n; i++){
            ...
            text.setBackground(null);
            text.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
            text.setTextSize(TypedValue.COMPLEX_UNIT_DIP,3);
            text.setGravity(Gravity.CENTER_HORIZONTAL);
            text.setText("0");
            equals.addView(text);
        }
