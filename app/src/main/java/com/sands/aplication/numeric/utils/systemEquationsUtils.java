...
public class systemEquationsUtils {
    ...
    private double[] substitution(double[][] expandedMatrix, int[] marks) {
        double[] result = substitution(expandedMatrix);
    ...
    private double[] substitution(double[][] expandedMatrix) {//regression
    ...
    private double[] eliminationWithTotalPivot(double[][] matrix) {
    ...
    private double[] simpleElimination(double[][] expandedMatrix) {
